    ...
    return (
        <div className="space-y-5 animate-fade-in">
            ...
            <div>
                ...
                {signals.length > 0 ? (
                    <>
                        <div className="flex h-7 rounded-lg overflow-hidden border border-b mb-3">
                            {bullCount > 0 && (
                                <div
                                    className="bg-bull flex items-center justify-center font-mono text-[10px] font-black text-bg transition-all"
                            ...
                            {neutCount > 0 && (
                                <div
                                    className="bg-b2 flex items-center justify-center font-mono text-[10px] font-bold text-t2"
                            ...
                            {bearCount > 0 && (
                                <div
                                    className="bg-bear flex items-center justify-center font-mono text-[10px] font-black text-bg transition-all"
            ...
            <div>
                ...
                <div className="bg-bg3 border border-b rounded-lg p-3 space-y-2">
                    <div className="flex items-center gap-2 flex-wrap">
                        <span className={cn(
                            "font-mono text-[9px] font-black px-2 py-0.5 rounded uppercase tracking-[0.5px]",
                            patternState === "CONFIRMED" ? "bg-bull/15 text-bull" :
                                patternState === "TRAP" ? "bg-bear/20 text-bear border border-bear/40" :
                    ...
                    {bullTrap && (
                        <div className="flex items-center gap-2 bg-bear/5 border border-bear/25 rounded p-2">
                            <span className="font-mono text-[10px] font-black text-bear">⚠ BULL TRAP — SHORT_SELL_SEARCH active</span>
                        </div>
                    )}
                    ...
                    {bullTrap && bearPivot && (
                        <div className="mt-2 p-2.5 rounded-lg bg-bear/5 border border-bear/20 space-y-1">
                            <div className="font-mono text-[9px] font-bold text-bear uppercase tracking-[0.5px]">Bear Pivot Entry Plan</div>
                            <div className="grid grid-cols-3 gap-2">
                                <div><div className="font-mono text-[8px] text-t3">Entry</div><div className="font-mono text-[12px] font-bold text-t1">{fmtPrice(bearPivot.entry_level as number)}</div></div>
                                <div><div className="font-mono text-[8px] text-t3">Stop</div><div className="font-mono text-[12px] font-bold text-bear">{fmtPrice(bearPivot.stop_level as number)}</div></div>
                                <div><div className="font-mono text-[8px] text-t3">Target</div><div className="font-mono text-[12px] font-bold text-bull">{fmtPrice(bearPivot.target as number)}</div></div>
                            </div>
                            {bearPivot.condition && (
                                <div className="font-mono text-[10px] text-t3">{bearPivot.condition as string}</div>
                            )}
                        </div>
                    )}
                    ...
                    {((l4.measured_move_target1 as number) || (l4.invalidation_level as number)) && (
                        <div className="grid grid-cols-3 gap-2 pt-1">
                            {l4.measured_move_target1 && (
                                <div className="bg-bg border border-b rounded p-2">
                                    <div className="font-mono text-[8px] text-t3 uppercase">Target 1</div>
                            ...
                            {l4.measured_move_target2 && (
                                <div className="bg-bg border border-b rounded p-2">
                                    <div className="font-mono text-[8px] text-t3 uppercase">Target 2</div>
                            ...
                            {l4.invalidation_level && (
                                <div className="bg-bg border border-b rounded p-2">
                                    <div className="font-mono text-[8px] text-t3 uppercase">Invalidation</div>
            ...
            <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    {(["daily", "hourly", "intraday", "scalp"] as const).map((tf) => {
                        ...
                        return (
                            <div key={tf} className="bg-bg3 border border-b rounded-lg p-2.5">
                                <div className="font-mono text-[8px] text-t3 uppercase tracking-[0.5px] mb-1">{label}</div>
                                <div className={cn(
