...
export const VERDICT_COLORS: Record<VerdictType, {
    ...
    BULL_TRADE:  { bg: "bg-bull/10", border: "border-bull", text: "text-bull", glow: "shadow-verdict-bull", hex: "#34d399" },
    BEAR_TRADE:  { bg: "bg-bear/10", border: "border-bear", text: "text-bear", glow: "shadow-verdict-bear", hex: "#f87171" },
